...
class JobTracker:
    class Task:
        def __init__(self, task_type: str, tracker: "JobTracker", metadata: dict = None):
    ...
    def task(self, task_type: str, metadata: dict = None):
        return self.Task(task_type, tracker=self, metadata=metadata)
